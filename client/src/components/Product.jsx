...
export default function Products() {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-gray-100 min-h-screen">
      <div className="relative md:w-1/5 p-4 bg-white shadow-md group">
        <div className="absolute left-0 top-0 h-full w-12 bg-white shadow-md transform -translate-x-full group-hover:translate-x-0 transition-transform duration-300 ease-in-out">
          <div className="p-4">
      ...
      <div className="md:w-4/5 p-4 sm:px-10 lg:px-20">
